...
def run(params):
    ...
    def build_model(embedding_matrix, max_sentence_length, number_of_classes):
        ...
        dropout_1 = Dropout(0.5)(embedded_sequences)
        l_lstm = LSTM(100, return_sequences=True)(dropout_1)
        dropout_2 = Dropout(0.5)(l_lstm)
    ...
    class F1ScoreModelCheckpointer(Callback):
        ...
        def on_epoch_end(self, batch, logs={}):
            ...
            if f1_dev > self.best_f1:
                print("Epoch {0}: F1 scores improved from {1} to {2}, saving model to results\lstm.model".format(batch,
                                                                                                                 self.best_f1,
                                                                                                                 f1_dev))
